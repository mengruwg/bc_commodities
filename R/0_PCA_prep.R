...
write_rds(a, "/bc_commodities/data/raw_data/commodities.rds")

# Nickel_price, Nickel_Index, Nickel_Price, Nickel_Index, Lead_Price, Lead_Index, Tin_Price, Tin_Index, Zinc_Price, Zinc_Index, Steel_Price, Steel_Index, Iron_Price, Iron_Index, Iron_Index2, Gold_Price, Platinum_Price, Palladium_Price, Silver_Price, Oil_Price, Oil2_Price, Gas_Price, BBEnergy_index, Precious_metals_index, BBEnergyIndustrial_index, BBEnergyEnergy_index, SPIndustrial_index, SP_index , SP.prec.met_index, SP.crude.oil_index, SP.Nat.Gas_index, SP.Agri_index, SP.Agri.Live_index, SP.Livestock_index, SP.Energy_index, SP.Copper_index, SP.Nickelminium_index, SP.Gold_index, Brent3, Brent2, Brent1, Brent6, WTI3, WTI2, WTI1, WTI6)

write_rds(data_commodities, "comdat.RDS")
write_rds(data_indices, "indices.RDS")
write_rds(data_oilfutures, "futures.RDS")
