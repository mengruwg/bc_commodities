...
a <- merge(a, BBIndustrial_index, by = "Date", all = TRUE)
a <- merge(a, Brent1, by = "Date", all = TRUE)
a <- merge(a, Brent2, by = "Date", all = TRUE)
a <- merge(a, Brent3, by = "Date", all = TRUE)
a <- merge(a, Brent6, by = "Date", all = TRUE)
a <- merge(a, Copper_index, by = "Date", all = TRUE)
a <- merge(a, Copper_price, by = "Date", all = TRUE)
a <- merge(a, Gas_Price, by = "Date", all = TRUE)
a <- merge(a, Gold_Price, by = "Date", all = TRUE)
a <- merge(a, Iron_Index, by = "Date", all = TRUE)
a <- merge(a, Iron_Index2, by = "Date", all = TRUE)
a <- merge(a, Iron_Price, by = "Date", all = TRUE)
a <- merge(a, Lead_Index, by = "Date", all = TRUE)
a <- merge(a, Lead_Price, by = "Date", all = TRUE)
a <- merge(a, Nickel_Index, by = "Date", all = TRUE)
a <- merge(a, Nickel_Price, by = "Date", all = TRUE)
a <- merge(a, Oil_Price, by = "Date", all = TRUE)
a <- merge(a, Oil2_Price, by = "Date", all = TRUE)
a <- merge(a, Palladium_Price, by = "Date", all = TRUE)
a <- merge(a, Platinum_Price, by = "Date", all = TRUE)
a <- merge(a, Precious_metals_index, by = "Date", all = TRUE)
a <- merge(a, Silver_Price, by = "Date", all = TRUE)
a <- merge(a, SP_index, by = "Date", all = TRUE)
a <- merge(a, SP.Agri_index, by = "Date", all = TRUE)
a <- merge(a, SP.Agri.Live_index, by = "Date", all = TRUE)
a <- merge(a, SP.Aluminium_index, by = "Date", all = TRUE)
a <- merge(a, SP.Copper_index, by = "Date", all = TRUE)
a <- merge(a, SP.crude.oil_index, by = "Date", all = TRUE)
a <- merge(a, SP.Energy_index, by = "Date", all = TRUE)
a <- merge(a, SP.Gold_index, by = "Date", all = TRUE)
a <- merge(a, SP.Livestock_index, by = "Date", all = TRUE)
a <- merge(a, SP.Nat.Gas_index, by = "Date", all = TRUE)
a <- merge(a, SP.prec.met_index, by = "Date", all = TRUE)
a <- merge(a, SPIndustrial_index, by = "Date", all = TRUE)
a <- merge(a, Steel_Index, by = "Date", all = TRUE)
a <- merge(a, Steel_Price, by = "Date", all = TRUE)
a <- merge(a, Tin_Index, by = "Date", all = TRUE)
a <- merge(a, Tin_Price, by = "Date", all = TRUE)
a <- merge(a, WTI1, by = "Date", all = TRUE)
a <- merge(a, WTI2, by = "Date", all = TRUE)
a <- merge(a, WTI3, by = "Date", all = TRUE)
a <- merge(a, WTI6, by = "Date", all = TRUE)
